...
public class SceneLoader : MonoBehaviour
{
    ...
    public Dictionary<string, LoadSceneMode> loadSccenes = new Dictionary<string, LoadSceneMode>();

    //호출할 씬의 정보 설정
     void InitSceneInfo()
    {
        //호출할 씬의 정보를 딕셔너리에 추가
        loadSccenes.Add("Level1", LoadSceneMode.Additive);
        loadSccenes.Add("Play", LoadSceneMode.Additive);
    }
    ...
    IEnumerator Start()
    {
        ...
        //여러 개 의 씬을 코루틴으로 호출
        foreach(var _loadScene in loadSccenes)
        {
